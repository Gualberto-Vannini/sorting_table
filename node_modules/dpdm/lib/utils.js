...
exports.prettyWarning = exports.prettyCircular = exports.prettyTree = exports.parseWarnings = exports.parseDependents = exports.parseCircular = exports.shortenTree = exports.simpleResolver = exports.appendSuffix = exports.normalizeOptions = exports.defaultOptions = void 0;
...
function parseCircular(tree, skipDynamicImports = false) {
    const circulars = [];
    ...
    function visit(id, used) {
        ...
        if (index > -1) {
            ...
            deps &&
                deps.forEach((dep) => {
                    if (dep.id &&
                        (!skipDynamicImports || dep.kind !== consts_1.DependencyKind.DynamicImport)) {
